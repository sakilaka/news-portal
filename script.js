...
const displayCategories = catagories =>{
    ...
    catagoryDiv.innerHTML = `<div onclick="loadCategoryDetails(${category.category_id})" class="fs-4 fw-bold p-2 rounded-2 bg-dark text-white">${category.category_name}</div>`
